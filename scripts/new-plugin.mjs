...
if (!slug || !displayName || !description) {
  throw new Error('Usage: node scripts/new-plugin.mjs <slug> "Display name" "Description"')
}
...
writeFileSync(join(pluginRoot, 'README.md'), `# ${displayName}\n\n${description}\n`)
writeFileSync(join(pluginRoot, 'CHANGELOG.md'), `# Changelog\n\n## 1.0.0\n\nInitial release.\n`)
writeFileSync(
